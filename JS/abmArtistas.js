...
const agregarImagenBackgroundArtista = document.getElementById(
  `imagenBackgroundURLAgregar`
);
...
const agregarArtista = () => {
  for (let i = 0; i < artistas.length; i++) {
      ...
      "imagenURL" + artistas[i].id
                    ...
                    <div class="mb-3">
                      ...
                      <button type="button" class="btn btn-primary" id="${
                        "btnModificarArtista" + artistas[i].id
                      }">
                        Guardar cambios
                      </button>
                    </div>
    ...
    const inputNombre = document.getElementById(
      "nombreArtista" + artistas[i].id
    );
    const inputimagenURL = document.getElementById(
      "imagenURL" + artistas[i].id
    );
    const inputimagenBackgroundURL = document.getElementById(
      "imagenBackgroundURL" + artistas[i].id
    );
